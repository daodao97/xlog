...
replace github.com/docker/docker/api => github.com/docker/docker v24.0.9+incompatible

replace github.com/docker/docker/client => github.com/docker/docker v24.0.9+incompatible
